  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-slate-500">Set and track your monthly spending limits</p>
      </header>
      ...
      {alerts.length > 0 && (
        ...
        >
          ...
          <div className="space-y-1">
            {alerts.map((alert) => (
              <p key={alert.category} className="text-sm text-amber-700">
          ...
          return (
            <motion.div
              ...
              className={`bg-white p-6 rounded-3xl border shadow-sm hover:shadow-md transition-shadow ${
                budgetStatus.alert_triggered ? 'border-red-200' : 'border-slate-100'
              }`}
            >
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">{budgetStatus.category}</h3>
              ...
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className={`font-semibold ${
                    budgetStatus.alert_triggered ? 'text-red-600' : 'text-slate-900'
                  }`}>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="bg-slate-50 p-3 rounded-xl">
                  ...
                  <p className={`font-semibold ${
                    budgetStatus.remaining < 0 ? 'text-red-600' : 'text-slate-900'
                  }`}>
                    ₹{budgetStatus.remaining.toFixed(0)}
                  </p>
                </div>
                <div className="bg-slate-50 p-3 rounded-xl">
                  <p className="text-slate-400 text-xs">Alert At</p>
                  <p className="font-semibold text-slate-900">{budget.alert_threshold}%</p>
                </div>
              </div>
            </motion.div>
          );
      ...
      {status.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-slate-500 mb-4">Create budgets to track and control your spending</p>
          <button
            onClick={() => setShowAddModal(true)}
