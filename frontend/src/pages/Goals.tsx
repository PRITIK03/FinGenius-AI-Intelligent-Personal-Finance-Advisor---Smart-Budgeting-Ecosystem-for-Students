  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Savings Goals</h1>
        <p className="text-slate-500">Track and achieve your financial milestones</p>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-slate-500">Total Goals</span>
            </div>
            <p className="text-2xl font-bold text-slate-900">{summary.total_goals}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-bold text-slate-900">₹{summary.total_saved?.toFixed(0)}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-bold text-slate-900">₹{summary.total_target?.toFixed(0)}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-bold text-slate-900">{summary.completed_goals}</p>
          </motion.div>
        </div>
      )}
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <span className="text-xs text-slate-400 uppercase tracking-wider">{goal.category}</span>
              </div>
            ...
            <button
              ...
              className="w-full py-2 bg-slate-50 text-slate-700 font-semibold rounded-xl hover:bg-slate-100 transition-all"
            >
              Add Contribution
            </button>
          </motion.div>
      ...
      {goals.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-slate-500">Create your first savings goal to start tracking your progress</p>
        </div>
      )}
